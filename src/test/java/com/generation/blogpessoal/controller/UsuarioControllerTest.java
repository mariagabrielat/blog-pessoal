...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(new Usuario(null, "Maria Silva", "maria@email.com.br", "12345678", "-"));
	...
	public void naoDeveDuplicarUmUsuario() {
		...
		usuarioService.cadastrarUsuario(new Usuario(null, "Maria da Silva", "maria_silva@email.com.br", "13245678", "-"));
		
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(new Usuario(null, "Maria da Silva", "maria_silva@email.com.br", "13245678", "-"));
	...
	public void deveAtualizarUmUsuario() {
		...
		Usuario usuarioUpdate = new Usuario(usuarioCadastrado.get().getId(),"juliana Andrews ramos", "julianan_ramos@email.com.br", "juliana123", "-");
